...
export class AnterosProgressButton extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleClick = this
            .handleClick
            .bind(this);
        this.handlePromise = this
            .handlePromise
            .bind(this);
        this.loading = this
            .loading
            .bind(this);
        this.notLoading = this
            .notLoading
            .bind(this);
        this.enable = this
            .enable
...
AnterosProgressButton.propTypes = {
...
AnterosProgressButton.defaultProps = {
    classNamespace: 'pb-',
    controlled: false,
    durationError: 1200,
    durationSuccess: 500,
