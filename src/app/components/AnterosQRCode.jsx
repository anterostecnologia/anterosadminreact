...
export class AnterosQRCode extends React.Component {
    constructor(props){
        super(props);
        this.update = this.update.bind(this);
        this.utf16to8 = this.utf16to8.bind(this);
    }
    shouldComponentUpdate(nextProps) {
        var that = this;
        return Object.keys(AnterosQRCode.propTypes).some(function(k) {
