...
import AnterosFade from './AnterosFade';
import {
    getOriginalBodyPadding,
    conditionallyUpdateScrollbar,
    setScrollbarWidth,
    mapToCssModules,
} from '../utils/AnterosUtils';
...
export default class AnterosModal extends Component {
    ...
    renderModalDialog() {
        ...
        return (
            <div style={{ maxWidth: this.props.width, maxHeight: this.props.height }}
                className={mapToCssModules(classNames('modal-dialog', (this.props.extraSmall ? "modal-extra-small" : ""),
            ...
            >
                <div style={{ maxWidth: this.props.width, height: this.props.height }}
