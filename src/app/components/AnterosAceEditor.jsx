...
export class AnterosAceEditor extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!lodash.isEqual(nextProps.setOptions, oldProps.setOptions)) {
      this.handleOptions(nextProps);
    }
    if (!lodash.isEqual(nextProps.annotations, oldProps.annotations)) {
      this.editor.getSession().setAnnotations(nextProps.annotations || []);
    }
    if (!lodash.isEqual(nextProps.markers, oldProps.markers) && (Array.isArray(nextProps.markers))) {
      this.handleMarkers(nextProps.markers);
    }

    // this doesn't look like it works at all....
    if (!lodash.isEqual(nextProps.scrollMargin, oldProps.scrollMargin)) {
