 ...
 *         newbreedofgeek
 */
export default class AnterosStepWizard extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="multi-step" onKeyDown={(evt) => {this.handleKeyDown(evt)}}>
        ...
        <div style={this.props.showNavigation ? {} : this.hidden} className="footer-buttons">
          <button style={this.state.showPreviousBtn ? {} : this.hidden}
                  className="btn btn-prev btn-primary pull-left"
...
AnterosStepWizard.defaultProps = {
  showSteps: true,
  showNavigation: true,
